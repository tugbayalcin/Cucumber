...
public class AmazonStepDefinitions {
    ...
    public void i_phone_icin_arama_yapar() {
        amazonPages.aramaKutusuElementi.sendKeys("iPhone" + Keys.ENTER);
    }
    ...
    public void tea_pot_icin_arama_yapar() {
        amazonPages.aramaKutusuElementi.sendKeys("tea pot" + Keys.ENTER);
    }
    ...
    public void flower_icin_arama_yapar() {
        amazonPages.aramaKutusuElementi.sendKeys("flower" + Keys.ENTER);
    }
    ...
    public void icin_arama_yapar(String arananKelime) {
        amazonPages.aramaKutusuElementi.sendKeys(arananKelime + Keys.ENTER);
    }
